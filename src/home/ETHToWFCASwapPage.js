...
const ETHToWFCASwapPage = ({memberStore}) => {
...
ETHToWFCASwapPage.navigationOptions = ({screenProps}) => {
  return {
...
export default inject('memberStore')(observer(ETHToWFCASwapPage));
